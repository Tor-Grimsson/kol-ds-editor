...
- **DS:** consumes published `@kolkrabbi/kol-*` via npm (external consumer, no linking); **component + theme 0.6.0** (unified sm/md/lg size scale across Button/SegmentedToggle/Input + `@media (hover:hover)` button-hover guard) · framework 0.2.1 · loader 0.3.0 · **icons 0.5.0**. ⚠ `kol-component`/`kol-theme` `peerDependencies` ranges still stale (`^0.1.2`).
