...
export default {
  ...
  params: [
    ...
    { key: 'thread', label: 'Thread', type: 'color', role: 'fg', default: '#ffffff' },
    ...
    { key: 'ballSpeed', label: 'Ball speed', type: 'range', min: 0.25, max: 3, step: 0.05, default: 1 },
    { key: 'lineSpeed', label: 'Line speed', type: 'range', min: 0, max: 1, step: 0.01, default: 0.22 },
    ...
    { key: 'ballR', label: 'Ball size', type: 'range', min: 4, max: 80, step: 1, default: 40 },
